...
import { getHeatMap } from '../../dataApi/getGeneData';
import LoadingGlower from '../../../../components/LoadingGlower';
import MyAlert from '../../../../components/MyAlert';

export default function HeatMap ({ gene, omics, feature, dataset, specimen, element }) {
  ...
  useEffect(() => {
    setIsLoading(true);
    getHeatMap(gene, omics, feature, dataset, specimen, element)
      .then((image) => {
        setImage(image);
